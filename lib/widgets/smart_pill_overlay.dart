...
class _SmartPillOverlayState extends State<SmartPillOverlay> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        if (_isVisible)
          Positioned(
            top: 60, // Drops down from the header
            left: 16,
            right: 16,
              ...
              child: GestureDetector(
                onVerticalDragEnd: (details) {
                  ...
                  if (details.primaryVelocity! < 0) {
                     _hideTimer?.cancel();
                     _animController.reverse().then((_) => setState(()=> _isVisible = false));
                  }
                },
                child: Material(
